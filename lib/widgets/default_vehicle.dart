...
class DefaultVehicleWidget extends StatefulWidget {

  final Vehicle vehicle;
  final bool isClickable;
  final ColorTheme colorTheme;

  const DefaultVehicleWidget({
    super.key,
  ...
  @override
  State<DefaultVehicleWidget> createState() => _VehicleWidgetState();
}

class _VehicleWidgetState extends State<DefaultVehicleWidget> {
  @override
